...
[Backends, configuring and extending](https://github.com/iedon/go-guerrilla/wiki/Backends,-configuring-and-extending) page.
...
- Modular [Backend system](https://github.com/iedon/go-guerrilla/wiki/Backends,-configuring-and-extending) 
- Modern TLS support (STARTTLS or SMTPS).
- Can be [used as a package](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package) in your Go project. 
Get started in just a few lines of code!
- [Fuzz tested](https://github.com/iedon/go-guerrilla/wiki/Fuzz-testing). 
[Auto-tested](https://travis-ci.org/iedon/go-guerrilla). Battle Tested.
...
See the [build notes](https://github.com/iedon/go-guerrilla/wiki/Build-Notes) for more details.
...
The configuration options are detailed on the [configuration page](https://github.com/iedon/go-guerrilla/wiki/Configuration). 
...
- Try setting up an [example configuration](https://github.com/iedon/go-guerrilla/wiki/Configuration-example:-save-to-Redis-&-MySQL) 
...
- Try hacking the source and [create your own processor](https://github.com/iedon/go-guerrilla/wiki/Backends,-configuring-and-extending).
- Once your daemon is running, you might want to stup [log rotation](https://github.com/iedon/go-guerrilla/wiki/Automatic-log-file-management-with-logrotate).
...
Next, you may want to [change the interface](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#starting-a-server---custom-listening-interface) (`127.0.0.1:2525`) to the one of your own choice.

#### API Documentation topics

Please continue to the [API documentation](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package) for the following topics:


- [Suppressing log output](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#starting-a-server---suppressing-log-output)
- [Custom listening interface](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#starting-a-server---custom-listening-interface)
- [What else can be configured](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#what-else-can-be-configured)
- [Backends](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#backends)
    - [About the backend system](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#about-the-backend-system)
    - [Backend Configuration](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#backend-configuration)
    - [Registering a Processor](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#registering-a-processor)
- [Loading config from JSON](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#loading-config-from-json)
- [Config hot-reloading](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#config-hot-reloading)
- [Logging](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#logging-stuff)
- [Log re-opening](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#log-re-opening)
- [Graceful shutdown](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#graceful-shutdown)
- [Pub/Sub](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#pubsub)
- [More Examples](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#more-examples)
...
- [guerrillad command](https://github.com/iedon/go-guerrilla/wiki/Running-from-command-line#guerrillad-command)
    - [Starting](https://github.com/iedon/go-guerrilla/wiki/Running-from-command-line#starting)
    - [Re-loading configuration](https://github.com/iedon/go-guerrilla/wiki/Running-from-command-line#re-loading-the-config)
    - [Re-open logs](https://github.com/iedon/go-guerrilla/wiki/Running-from-command-line#re-open-log-file)
    - [Examples](https://github.com/iedon/go-guerrilla/wiki/Running-from-command-line#examples)

### Other topics

- [Using Nginx as a proxy](https://github.com/iedon/go-guerrilla/wiki/Using-Nginx-as-a-proxy)
- [Using HAProxy](https://github.com/iedon/go-guerrilla/wiki/Using-HAProxy)
- [Testing STARTTLS](https://github.com/iedon/go-guerrilla/wiki/Running-from-command-line#testing-starttls)
- [Benchmarking](https://github.com/iedon/go-guerrilla/wiki/Profiling#benchmarking)
...
[Daemon.AddProcessor](https://github.com/iedon/go-guerrilla/wiki/Using-as-a-package#registering-a-processor) function to register, then add to your config.
...
See our [change log](https://github.com/iedon/go-guerrilla/wiki/Change-Log) for change and release history
...
For such purposes as load balancing, terminating TLS early,
 ...
 it is possible to [use NGINX as a proxy](https://github.com/iedon/go-guerrilla/wiki/Using-Nginx-as-a-proxy).
